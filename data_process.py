...
from torch_geometric.datasets import Planetoid, WebKB, Coauthor, Amazon, LRGBDataset
...
def load_data(data_name, new_split=False, train_spilt=0.6, device='cuda:0'):
    ...
    if data_name in ['cora', 'citeseer', 'pubmed']:
        ...
        dataset = LRGBDataset(root_path, name=data_name, transform=transform)
    data = dataset[0]
    if new_split:
